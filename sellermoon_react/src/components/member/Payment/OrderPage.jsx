              ...
              <div className="mb-3 row">
                ...
                <div className="col-sm-7 d-flex">
                  <input
                    ...
                    value={payInfo.member_address_detail}
                    onChange={EditChange}
                    className="form-control"
                  />
                </div>
